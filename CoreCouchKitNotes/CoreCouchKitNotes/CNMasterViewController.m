...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.couchQuery = [CCQuery queryForObjectsOfType:@"CNNote" 
                                               whose:nil 
                                                  is:nil 
                                         inCoreCouch:[CoreCouchKit sharedCoreCouchKit]];
    [self.couchQuery start];
}
...
{
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
        CNNote *selectedObject = [[self fetchedResultsController] objectAtIndexPath:indexPath];
        self.detailViewController.note = selectedObject;
    }
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ...
        CNNote *selectedObject = [[self fetchedResultsController] objectAtIndexPath:indexPath];
        [[segue destinationViewController] setNote:selectedObject];
    }
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSFetchRequest *fetchRequest = [NSFetchRequest fetchRequestWithEntityName:@"CNNote"];
